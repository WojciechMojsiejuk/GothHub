"""
Django settings for GothHub project.
...
SECRET_KEY = 's&=@d6q0j=**2bawa=8f5y$+0(_qtyjfv46#%m_))+x7d+)i^b'
...
WSGI_APPLICATION = 'GothHub.wsgi.application'
